...
2. Personal access token of an admin in that organization (obtainable in GitHub account settings) that has at least write:org permission under admin:org when the token was created.
