...
Usage: github-invite <org> <token> <username>
  ...
  org          The name of an organization in GitHub into which a user
               is to be invited.
  token        A personal access token of an admin member in the organization.
  ...
  username     The username of the GitHub user to be invited to the provided
               organization.
